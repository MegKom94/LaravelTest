...
use App\Common\Database\SimplePaginator;
...
abstract class SimplePaginateTransformer implements Responsable
{
    /**
    ...
    /**
     * @var Collection|SimplePaginator|object
     */
    private $data;
    ...
    protected function performTransform($request)
    {
        ...
        if ($data instanceof Collection || $data instanceof SimplePaginator) {
